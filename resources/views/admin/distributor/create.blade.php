...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form role="form" method="POST" action="{{route('admin.distributor.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group" {{$errors->first('d_name') ? 'has-error' : ''}}>
                              ...
                              <input type="text" class="form-control" name="d_name" placeholder="Nhập tên Nhà Phân Phối">
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="height: 155px" type="text" class="form-control" name="d_description" placeholder="Mô tả"></textarea>
                        ...
                        <div class="modal-footer">
                            <div class="mx-auto">
                                <a type="button" class="btn btn-danger" href="{{route('admin.distributor.index')}}">Hủy</a>
