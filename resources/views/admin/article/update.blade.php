                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group" {{$errors->first('a_name') ? 'has-error' : ''}}>
                                ...
                                <input type="text" class="form-control" name="a_name" placeholder="Nhập tên bài viết" value="{{$article->a_name ?? old('a_name')}}"> @if ($errors->first('a_name'))
                            ...
                            <div class="form-group" {{$errors->first('a_name') ? 'has-error' : ''}}>
                                ...
                                <select id="a_menu_id" name="a_menu_id" class="form-control" data-type="category">
                                    ...
                                    <option value="{{$data->id}}" {{ ($article->a_menu_id ?? 0 == $article->id) ? "selected='selected'" :""}}>{{$data->mn_name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="height: 155px" type="text" class="form-control" id="a_description" name="a_description" placeholder="Mô tả">{{$article->a_description ?? old('a_description')}}</textarea>
                ...
                <div class="col-5">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="a_avatar" class="custom-file-input" id="imgInput" value="{{$article->a_avatar ?? old('a_avatar')}}">
                            ...
                            @endif
                            <div class="">
                                <img id="imgPreview" src="{{pare_url_file($article->a_avatar) }}" height="290" class="Product Image">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea id="ckeditor" name="a_contents" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$article->a_contents ?? old('a_contents')}}</textarea>
                            </div>
