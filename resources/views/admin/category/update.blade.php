                    ...
                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group" {{$errors->first('c_name') ? 'has-error' : ''}}>
                              <label for="lessonname" class="control-label">Tên Danh Mục <span class="text-danger">(*)</span></label>
                              <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Nhập tên danh mục" value="{{$category->c_name}}">
