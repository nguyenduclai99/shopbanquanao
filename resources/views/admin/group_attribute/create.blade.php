...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form role="form" method="POST" action="{{route('admin.group_attribute.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group" {{$errors->first('ga_name') ? 'has-error' : ''}}>
                              <label for="ga_name" class="control-label">Tên Thuộc Tính <span class="text-danger">(*)</span></label>
                              <input type="text" class="form-control" id="ga_name" name="ga_name" placeholder="Nhập tên nhóm thuộc tính" value="{{old('ga_name')}}">
