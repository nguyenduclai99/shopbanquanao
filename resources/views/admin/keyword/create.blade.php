...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form role="form" method="POST" action="{{route('admin.keyword.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group" {{$errors->first('k_name') ? 'has-error' : ''}}>
                              ...
                              <input type="text" class="form-control" id="k_name" name="k_name" placeholder="Nhập tên keyword">
                            ...
                            <div class="form-group">
                              ...
                              <textarea type="text" class="form-control" id="k_description" name="k_description" placeholder="Mô tả"></textarea>
